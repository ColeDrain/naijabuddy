...
The same agent serves **Task B: Recommendation**, described in the companion Task B paper, sharing the architecture, Critic Layer, and evaluation harness reported here.
